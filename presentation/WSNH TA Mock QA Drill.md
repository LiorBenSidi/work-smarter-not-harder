...
> All **seven** sub-features: posts + comments with image/video · like/dislike with counts + a personal
> received-vote total · direct messages (P2P + media) · notifications (DMs + who liked you) · anti-abuse
> (rate-limits + file-size caps) · cold-seeding. Everything **real-time** over SSE (no refresh), retrievable
> chat history, plus an **anonymity toggle** as a retained bonus.
