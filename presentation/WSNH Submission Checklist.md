...
**Team Git Push & Pray** — Shiri · Lior · Elad · IDs **318155801 · 207490913 · 319000725**
**Naming convention:** `<id>_<id>_<id>` → **`318155801_207490913_319000725`** (used for the zip + video, e.g.
`WSNH_318155801_207490913_319000725.zip`, `VID_318155801_207490913_319000725.mp4`).
...
- [ ] **Report** — `docs/REPORT.md` (app overview · features×tests matrix · risk assessment). ✅ current
      (720 tests). Export to PDF if the TA wants a file.
...
- [x] Suite green — **686 passing / 34 env-gated (720 collected)**; `main` green.
