...
**Ready-to-paste note:**
> DEMO · ~30–45s · pre-recorded recommended. "Rather than tell you it works — here it is, live: a 30-second morning check-in, the readiness signal, and a post in the forum, all on the deployed app." CUE: play the clip (`VID_<id1>_<id2>_<id3>.mp4`) on click.
