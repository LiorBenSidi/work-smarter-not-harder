...
Project documents for **Work Smarter, Not Harder** (WSML 00950219 final project).
...
> These reference docs are kept in-repo so the project is self-contained.
> **Don't commit files with real student IDs in their names** — strip IDs for the shared repo (the proposal is stored here as `PROPOSAL.md`, not under its `..._<IDs>_...` submission name).
