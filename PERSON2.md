...
- [x] **Recovery/breathing frontend + installable PWA** (#84/#89) — the mobile-app shell (bottom tab nav · Today/History/Forum/Profile · readiness confidence bars · history sparkline), an aurora recovery identity, and an installable PWA (manifest + root-scope service worker); live-verified desktop + mobile, dark + light.
